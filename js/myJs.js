const textConfig = {
  ...
  text3: "Em thích anh phải không ạ ^^ ",
  text4: "Nếu Em không trả lời mà thoát ra tức là iu Anh rùi đó nha :v",
  text5: "Anh mơ à???",
    ...
    Swal.fire({
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://www.facebook.com/messages/t/100010228658058";
          },
        });
      }
    });
